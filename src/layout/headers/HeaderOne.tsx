  ...
  return (
    <>
      <header>
        <div
          id="header-sticky"
          className={`tptransparent__header header-1 ${
        ...
        >
                      ...
                      <div className="search-btn-wrap">
                        <button
                          className={`button-search-toggle ${
                            openSearch ? "tp-search-icon-active" : ""
                          }`}
          ...
          <div
            className="tp-search-area p-relative"
                ...
                <div className="col-xl-12">
                  <div className="tp-search-form p-relative">
                    <form onSubmit={(e) => e.preventDefault()}>
                      <input
                        type="text"
                        placeholder='Try "freelance" or "typography"..."'
                      />
